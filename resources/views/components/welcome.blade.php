<div class="p-6 lg:p-8 bg-white border-b border-gray-200">ddf
    <x-application-logo class="block h-12 w-auto" />

    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Welcome to your Jetstream application! dvd
    </h1>
    ...
    <p class="mt-6 text-gray-500 leading-relaxed">
        ...
        Laravel
        ecosystem to be a breath of fresh air. We hope you love it. findvd
    </p>
</div>
